...
```
If you leave NODE_ENV out, the default settings will be used. So if you just have one environment, you can populate the
default section in the env-settings.json and point the endpoints to your one web-service endpoint.
